...
const RegistrationScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Button title="Sign up" buttonStyle={styles.signupButton} onPress={() => {}} />
      ...
      <Text style={styles.footerText}>
        Already have an account? <Text style={styles.signinText} onPress={() => navigation.navigate('Login')}>Sign in</Text>
      </Text>
    </ScrollView>
  );
};
